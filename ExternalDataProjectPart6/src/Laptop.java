 ...
 * This is another updated version of this program that is now able to parse XML data using SAX and
 * DOM processing and process DAT files, as well as being able to process JSON files using
 * JSON.simple processing and write JSON files.
