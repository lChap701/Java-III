...
public class SAXProcessingXML extends DefaultHandler {
    ...
    public void characters(char[] ch, int start, int length) {
        ...
        if (!isEndTag) {    // if the current tag is not a closing tag
            switch (curTagName) {
                case "id":
                    laptop.setId(Integer.parseInt(value));
                    break;
                case "brand":
                    laptop.setBrand(value);
                    break;
                case "name":
                    laptop.setName(value);
                    break;
                case "productNumber":
                    laptop.setProductNumber(value);
                    break;
                case "serial":
                    laptop.setSerial(value);
                    break;
                case "os":
                    laptop.setOs(value);
                    break;
                case "ram":
                    laptop.setRam(Double.parseDouble(value));
                    break;
                case "cpu":
                    laptop.setCpu(value);
                    break;
                case "storage":
                    laptop.setStorage(Double.parseDouble(value));
                    break;
                case "price":
